...
#
# Script generated by Vivado on Sun Apr 19 19:25:39 +0200 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot aurora_8b10b xil_defaultlib.aurora_8b10b xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim aurora_8b10b -key {Behavioral:sim_1:Functional:aurora_8b10b} -tclbatch cmd.tcl -log simulate.log
}
