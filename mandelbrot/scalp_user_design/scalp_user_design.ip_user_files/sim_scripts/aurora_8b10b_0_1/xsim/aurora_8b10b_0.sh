...
#
# Script generated by Vivado on Sun Apr 19 18:22:45 +0200 2026
...
#
# Usage        : aurora_8b10b_0.sh
#                aurora_8b10b_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                aurora_8b10b_0.sh [-rerun]
#                aurora_8b10b_0.sh [-reset_run]
#                aurora_8b10b_0.sh [-clean]
#                aurora_8b10b_0.sh [-reset_log]
#                aurora_8b10b_0.sh [-help]
#
...
# script info
echo -e "aurora_8b10b_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./aurora_8b10b_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot aurora_8b10b_0 xil_defaultlib.aurora_8b10b_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim aurora_8b10b_0 -key {Behavioral:sim_1:Functional:aurora_8b10b_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c0d9.protoinst" -protoinst "protoinst_files/scalp_zynqps.protoinst" -protoinst "protoinst_files/vga_hdmi_clk_rst_system_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb aurora_8b10b_0.wdb xsim.dir libdpi.so)
...
Usage: aurora_8b10b_0.sh [-step]\n\
Usage: aurora_8b10b_0.sh [-lib_map_path]\n\
Usage: aurora_8b10b_0.sh [-rerun]\n\
Usage: aurora_8b10b_0.sh [-reset_run]\n\
Usage: aurora_8b10b_0.sh [-clean]\n\
Usage: aurora_8b10b_0.sh [-reset_log]\n\
Usage: aurora_8b10b_0.sh [-keep_index]\n\
