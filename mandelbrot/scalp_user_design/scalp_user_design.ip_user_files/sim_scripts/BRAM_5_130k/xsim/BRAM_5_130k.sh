...
#
# Script generated by Vivado on Fri May 22 20:33:41 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : BRAM_5_130k.sh
...
#
# Usage        : BRAM_5_130k.sh
#                BRAM_5_130k.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BRAM_5_130k.sh [-rerun]
#                BRAM_5_130k.sh [-reset_run]
#                BRAM_5_130k.sh [-clean]
#                BRAM_5_130k.sh [-reset_log]
#                BRAM_5_130k.sh [-help]
#
...
# script info
echo -e "BRAM_5_130k.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BRAM_5_130k.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BRAM_5_130k xil_defaultlib.BRAM_5_130k xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BRAM_5_130k -key {Behavioral:sim_1:Functional:BRAM_5_130k} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c0d9.protoinst" -protoinst "protoinst_files/scalp_zynqps.protoinst" -protoinst "protoinst_files/vga_hdmi_clk_rst_system_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BRAM_5_130k.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BRAM_5_130k.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BRAM_5_130k.sh [-help]\n\
Usage: BRAM_5_130k.sh [-step]\n\
Usage: BRAM_5_130k.sh [-lib_map_path]\n\
Usage: BRAM_5_130k.sh [-rerun]\n\
Usage: BRAM_5_130k.sh [-reset_run]\n\
Usage: BRAM_5_130k.sh [-clean]\n\
Usage: BRAM_5_130k.sh [-reset_log]\n\
Usage: BRAM_5_130k.sh [-keep_index]\n\
Usage: BRAM_5_130k.sh [-noclean_files]\n\n\
