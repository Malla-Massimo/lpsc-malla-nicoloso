...
#                script (type 'BRAM_5_130k.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/MA_LPSC/lpsc-malla-nicoloso/mandelbrot/scalp_user_design/scalp_user_design.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
