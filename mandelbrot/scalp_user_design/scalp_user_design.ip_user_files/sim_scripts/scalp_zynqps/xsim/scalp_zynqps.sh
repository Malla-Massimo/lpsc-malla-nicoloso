...
#
# Script generated by Vivado on Thu Apr 09 17:59:22 +0200 2026
...
#
# Usage        : scalp_zynqps.sh
#                scalp_zynqps.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                scalp_zynqps.sh [-rerun]
#                scalp_zynqps.sh [-reset_run]
#                scalp_zynqps.sh [-clean]
#                scalp_zynqps.sh [-reset_log]
#                scalp_zynqps.sh [-help]
#
...
# script info
echo -e "scalp_zynqps.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./scalp_zynqps.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L xlconstant_v1_1_10 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_36 -L fifo_generator_v13_2_14 -L axi_data_fifo_v2_1_36 -L axi_crossbar_v2_1_38 -L axi_protocol_converter_v2_1_37 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L axi_intc_v4_1_22 -L xlconcat_v2_1_7 -L axi_iic_v2_1_11 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot scalp_zynqps xil_defaultlib.scalp_zynqps xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim scalp_zynqps -key {Behavioral:sim_1:Functional:scalp_zynqps} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c0d9.protoinst" -protoinst "protoinst_files/scalp_zynqps.protoinst" -protoinst "protoinst_files/vga_hdmi_clk_rst_system_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb scalp_zynqps.wdb xsim.dir libdpi.so)
...
Usage: scalp_zynqps.sh [-step]\n\
Usage: scalp_zynqps.sh [-lib_map_path]\n\
Usage: scalp_zynqps.sh [-rerun]\n\
Usage: scalp_zynqps.sh [-reset_run]\n\
Usage: scalp_zynqps.sh [-clean]\n\
Usage: scalp_zynqps.sh [-reset_log]\n\
Usage: scalp_zynqps.sh [-keep_index]\n\
