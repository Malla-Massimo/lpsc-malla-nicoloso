...
// Date        : Tue Apr 21 18:33:49 2026
// Host        : LAPTOP-CHKLS7CN running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top scalp_zynqps_axi_iic_ioext_0 -prefix
//               scalp_zynqps_axi_iic_ioext_0_ scalp_zynqps_axi_iic_ioext_0_stub.v
...
(* CHECK_LICENSE_TYPE = "scalp_zynqps_axi_iic_ioext_0,axi_iic,{}" *) (* core_generation_info = "scalp_zynqps_axi_iic_ioext_0,axi_iic,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_iic,x_ipVersion=2.1,x_ipCoreRevision=11,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_S_AXI_ADDR_WIDTH=9,C_S_AXI_DATA_WIDTH=32,C_IIC_FREQ=100000,C_TEN_BIT_ADR=0,C_GPO_WIDTH=1,C_S_AXI_ACLK_FREQ_HZ=125000000,C_SCL_INERTIAL_DELAY=0,C_SDA_INERTIAL_DELAY=0,C_SDA_LEVEL=1,C_SMBUS_PMBUS_HOST=0,C_DISABLE_SETUP_VIOLATION_CHECK=0,C_STATIC_TIMING_REG_WIDTH=0,C_TIMING_REG_WIDTH=32,C_DEFAULT_VALUE=0x00}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_iic,Vivado 2025.2" *) 
module scalp_zynqps_axi_iic_ioext_0(s_axi_aclk, s_axi_aresetn, iic2intc_irpt, 
