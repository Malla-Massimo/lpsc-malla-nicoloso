...
HD_PWD='C:/master/lpsc/scalp_board_files-main/scalp_revc_windows/scalp_user_design/scalp_user_design.runs/scalp_zynqps_scalp_axi_link_firmwareid_0_synth_1'
cd "$HD_PWD"
